import 'phaser';
import forestImg from './assets/img/maps/map4.png';
import groundImg from './assets/img/platform/platform.png';
import consollImg from './assets/img/consolle-small.png';
import bombImg from './assets/img/bomb.png';
import dudeImg from './assets/img/dude2.png';
...
function create() {
  ...
  this.physics.add.overlap(player, consolls, collectConsoll, null, this);
...
function collectConsoll(player, consoll) {
