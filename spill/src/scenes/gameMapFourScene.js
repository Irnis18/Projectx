...
export default class GameMapFourScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image("backgroundFour", "assets/img/maps/map8.png");
    this.load.image(
      "platformFour",
      "assets/img/platform/mapFour/seaPlatform.png"
    );
    this.load.image(
      "platformFourTwo",
    ...
    this.load.spritesheet("player", "assets/img/gameItems/swimmer.png", {
      frameWidth: 48,
      frameHeight: 32
    });
  }
  ...
  create() {
    ...
    platforms.create(600, 400, "platformFourTwo");
    platforms.create(50, 250, "platformFourTwo");
    platforms.create(750, 220, "platformFourTwo");
    platforms.create(60, 420, "platformFourTwo");
    platforms.create(100, 420, "platformFourTwo");
    platforms.create(60, 420, "platformFourTwo");
    platforms.create(300, 120, "platformFourTwo");
